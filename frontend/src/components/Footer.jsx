    ...
    <footer className="bg-[#333333] text-gray-400 py-16 px-6 md:px-12 font-sans">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          {/* Column 2 & 3: Navigations (Combined for layout control) */}
          <div className="lg:col-span-2 grid grid-cols-2 gap-4">
            ...
            <div className="pt-12"> {/* Offset for second list in Navigations */}
              <ul className="space-y-3 text-sm">
        ...
        <div className="border-t border-gray-700 pt-8 text-center text-sm">
          <p>
            ...
            <Heart size={14} className="inline-block mx-1 text-red-500 fill-current" /> 
            by <a href="#" className="hover:text-white">Colorlib</a>
          </p>
        </div>
