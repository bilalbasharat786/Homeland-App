...
const Properties = () => {
  ...
  const properties = [
    {
      id: 1,
      image: img1, // Replace with your asset variable
      tags: [{ text: 'SALE', color: 'bg-red-500' }, { text: 'RENT', color: 'bg-green-500' }],
      price: "$2,265,500",
    ...
    {
      id: 2,
      image: house2, // Replace with your asset variable
      tags: [{ text: 'SALE', color: 'bg-red-500' }, { text: 'RENT', color: 'bg-green-500' }],
      price: "$2,265,500",
    ...
    {
      id: 1,
      image: house4, // Replace with your asset variable
      tags: [{ text: 'SALE', color: 'bg-red-500' }, { text: 'RENT', color: 'bg-green-500' }],
      price: "$2,265,500",
      address: "625 S. Berendo St",
      location: "625 S. Berendo St Unit 607 Los Angeles, CA 90005",
    ...
    {
      id: 2,
      image: house5, // Replace with your asset variable
      tags: [{ text: 'SALE', color: 'bg-red-500' }, { text: 'RENT', color: 'bg-green-500' }],
      price: "$2,265,500",
      address: "871 Crenshaw Blvd",
      location: "1 New York Ave, Warners Bay, NSW 2282",
    ...
    {
      id: 1,
      image: house7, // Replace with your asset variable
      tags: [{ text: 'SALE', color: 'bg-red-500' }, { text: 'RENT', color: 'bg-green-500' }],
      price: "$2,265,500",
      address: "625 S. Berendo St",
      location: "625 S. Berendo St Unit 607 Los Angeles, CA 90005",
    ...
    {
      id: 2,
      image: house8, // Replace with your asset variable
      tags: [{ text: 'SALE', color: 'bg-red-500' }, { text: 'RENT', color: 'bg-green-500' }],
      price: "$2,265,500",
      address: "871 Crenshaw Blvd",
      location: "1 New York Ave, Warners Bay, NSW 2282",
    ...
    <section className="w-full bg-gray-50 py-16 px-4 md:px-12">
      ...
      <div className="max-w-7xl mx-auto -mt-24 relative z-20 mb-12">
        <div className="bg-[#2C3E50] p-6 rounded-md shadow-lg flex flex-col md:flex-row gap-4 items-end">
          ...
          <div className="w-full">
            <label className="text-gray-400 text-xs font-bold uppercase tracking-wider mb-2 block">Listing Types</label>
          ...
          {/* Offer Type */}
          <div className="w-full">
            <label className="text-gray-400 text-xs font-bold uppercase tracking-wider mb-2 block">Offer Type</label>
            <div className="relative">
              <select className="w-full p-3 text-gray-700 bg-white rounded-sm outline-none appearance-none cursor-pointer">
          ...
          {/* Select City */}
          <div className="w-full">
            <label className="text-gray-400 text-xs font-bold uppercase tracking-wider mb-2 block">Select City</label>
            <div className="relative">
              <select className="w-full p-3 text-gray-700 bg-white rounded-sm outline-none appearance-none cursor-pointer">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
        <div className="flex gap-2">
            <button className="p-2 text-gray-800 hover:text-green-600"><LayoutGrid size={24} /></button>
            <button className="p-2 text-gray-400 hover:text-green-600"><List size={24} /></button>
        </div>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {properties.map((property) => (
          <div key={property.id} className="bg-white rounded-md shadow-sm hover:shadow-xl transition-shadow duration-300 group overflow-hidden">
            ...
            <div className="relative h-64 overflow-hidden">
              ...
              <div className="absolute top-4 left-4 flex flex-col gap-1">
                {property.tags.map((tag, index) => (
                  <span key={index} className={`${tag.color} text-white text-[10px] font-bold px-2 py-1 rounded-sm uppercase`}>
                    {tag.text}
                  </span>
                ))}
              </div>
            ...
            {/* Content Container */}
            <div className="p-6">
              <h3 className="text-xl font-medium text-gray-800 mb-2">{property.address}</h3>
              <div className="flex items-start gap-1 text-gray-400 text-sm mb-4">
                <MapPin size={16} className="mt-1 flex-shrink-0" />
                <p>{property.location}</p>
              </div>
              
              <p className="text-2xl font-bold text-[#83b735] mb-4">{property.price}</p>

              {/* Specs Footer */}
              <div className="flex items-center justify-between border-t border-gray-100 pt-4 text-gray-500 text-sm">
                <div>
                   <span className="block font-bold text-gray-800 text-lg">{property.beds}</span>
                   <span className="text-xs uppercase tracking-wide">Beds</span>
                </div>
                <div>
                   <span className="block font-bold text-gray-800 text-lg">{property.baths}</span>
                   <span className="text-xs uppercase tracking-wide">Baths</span>
                </div>
                <div>
                   <span className="block font-bold text-gray-800 text-lg">{property.sqft}</span>
