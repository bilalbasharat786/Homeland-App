...
// APNI ASSETS IMAGES YAHAN IMPORT KAREIN
  ...
  const agents = [
    {
      ...
      image: agent1, // Replace with agent1
    ...
    },
    {
      ...
      name: "Brooke Cagle",
      role: "Real Estate Agent",
      image: agent2, // Replace with agent2
    ...
    },
    {
      ...
      name: "Philip Martin",
      role: "Real Estate Agent",
      image: agent3, // Replace with agent3
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16 max-w-4xl mx-auto">
          ...
          <p className="text-gray-500 text-sm md:text-base leading-relaxed">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vero magnam officiis ipsa eum pariatur labore fugit amet eaque iure vitae, repellendus laborum in modi reiciendis quis! Optio minima quibusdam, laboriosam.
          </p>
        </div>
            ...
            <div key={agent.id} className="group">
              ...
              <div className="text-left">
                ...
                <div className="flex gap-4 text-black">
                  <a href="#" className="hover:text-[#83b735] transition-colors"><Facebook size={18} /></a>
                  <a href="#" className="hover:text-[#83b735] transition-colors"><Twitter size={18} /></a>
                  <a href="#" className="hover:text-[#83b735] transition-colors"><Linkedin size={18} /></a>
                </div>
              </div>
